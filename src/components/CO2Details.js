import { CssBaseline, Card, CardContent, CardHeader, Divider, Typography, useTheme } from '@mui/material';

export const CO2Details = (props) => {
console.log(props)
return (
    <div class="card bg-[#FFFFFF] w-80 h-[50rem] p-3 space-y-4 absolute left-0 top-0 z-10">
            <a href="#">
